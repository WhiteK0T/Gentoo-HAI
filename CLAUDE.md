...
2026-07-20: **чистый zero-touch прогон B пройден** (ISO с 8b1cd9e). Установка
на боевой VirtFusion-VPS прошла с нуля **без единого вмешательства**: сеть
поднялась сама (статик+onlink+MTU 1448), скачивание с yandex, сборка, halt,
загрузка с диска, ssh. Баг зависания `wait` (сторож не был `disown`) устранён.
